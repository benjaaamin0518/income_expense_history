...
import { createBorrowedUser, getBorrowedUsers } from "../hooks/useBorrowedUsers";
...
export function AddBorrowedUserDialog({ open, onOpenChange }: AddBorrowedUserDialogProps) {
